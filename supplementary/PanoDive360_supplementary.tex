...
%
% Anonymous / double-blind. Do not add author names or code URLs.
...
\hypersetup{colorlinks=true,linkcolor=black,citecolor=black,urlcolor=blue,pdfauthor={},pdfcreator={},pdfproducer={}}
...
video-inference cost. All numbers match the PanoDive360 paper graphs.
No author-identifying links are included.
\end{abstract}
